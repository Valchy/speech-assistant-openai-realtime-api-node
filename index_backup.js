				...
				switch (data.event) {
					case 'media':
						...
						if (openAiWs.readyState === WebSocket.OPEN) {
							// Instead of audio buffer to make it cheaper you can use other third party to translate audio into text
							// and send that instead, this should also make the translation better as it will be specific for bulgarian language
							...
							// 			{
							// 				type: 'input_text',
							// 				text: 'Коя карта е най-добра за човек който е студент?'
							// 			}
							// 		]
							// 	}
							// };
