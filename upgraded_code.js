...
// Constants
import { SYSTEM_MESSAGE, VOICE, PORT } from './constants.js';
const WEBHOOK_URL = 'https://hook.eu2.make.com/kbsw4f8elay8ysjltos8gvwxubpsa68b';
...
fastify.all('/incoming-call', async (request, reply) => {
	...
	const twimlResponse = `<?xml version="1.0" encoding="UTF-8"?>
                          <Response>
                              <Say>Hi, you have called Transcard Financial Services!</Say>
                              <Connect>
		...
		const response = await fetch('https://api.openai.com/v1/chat/completions', {
			...
			body: JSON.stringify({
				...
				messages: [
					{
						role: 'system',
						content: 'Extract customer details: full name, phone number, last 4 digits of card, and any special notes from the transcript.'
					},
				...
				response_format: {
					...
					json_schema: {
						...
						schema: {
							...
							required: ['full_name', 'phone_number', 'last_4_digits_of_card', 'special_notes']
						}
					}
				}
			})
